...
module.exports = () => {
  ...
  sliderConstructor(
      '#laters-post-carousel',
      {slidesSameTime: 3}, SimpleCarousel).sliderInit();

  sliderConstructor(
      '#main-carousel-slide-wrapper',
      {slidesSameTime: 1}, DraggableCarousel).sliderInit();

  sliderConstructor(
      '#testimonials-container',
      {slidesSameTime: 1}, AutoplayCarousel).sliderInit();
};
